...
<div class="container-fluid">
    <div class="">
        ...
        <div class="addStock" style="">
            ...
            <h1 style="font-size:1.2em; padding:24px 0px; font-weight:bold;">必要項目を記述してください</h1>
            ...
            <div class="form-group row" style="display:inline-flex; width:100%;">
                ...
                <form action="stockConfirm" method="post" enctype="multipart/form-data" class="addStock-form" style="margin:0 auto; width:70%">
                @csrf
                    ...
                    <div style="margin-top:40px">
                        ...
                        <input type="text" name="fee" id="fee" value="0" style="width:40%;">
                    </div>
